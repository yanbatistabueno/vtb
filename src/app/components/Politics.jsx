    ...
    <div className="politics-container">
      ...
      <div className="politics-list">
        <ul className="politics-list-container">
          <h3>
            A VTB através da competência, ética e profissionalismo da sua
            Direção e dos seus colaboradores objetiva:
          </h3>

          <li>
            Fornecer produtos e serviços que atendam às diferentes expectativas
            e necessidades de seus Clientes e partes interessadas;
          </li>
          <li>
