...
$_SESSION['licenca'] = $licenca;

$_SESSION['database-status'] = "";

$type = "Proposta de Software";
$_SESSION['type'] = $type;
...
if($_SERVER["REQUEST_METHOD"] == "POST" && $nome != ""){
    ...
    try {
        ...
        $query = "INSERT INTO proposta_software (nome,email,empresa,ramo,area,telefone,celular,software,licencas) VALUES (:nome,:email,:empresa,:ramo,:area,:telefone,:celular,:software,:licencas);";
        ...
        $stmt->bindParam(":licencas", $licenca);
        $stmt->execute();
