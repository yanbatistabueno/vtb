...
$type = "Fale Conosco";
$_SESSION['type'] = $type;
$body = $nome . " com o E-mail: " . $email . "com o telefone: " . $telefone . " te mandou um e-mail através do site." . "Assunto: " . $assunto . "Mensagem: " . $mensagem;
$htmlbody = "<html>
<body>
...
if($_SERVER["REQUEST_METHOD"] == "POST" && $nome != ""){
    ...
    try {
        ...
        $query = "INSERT INTO fale_conosco (nome,email,empresa,ramo,celular,telefone,assunto,mensagem) VALUES (:nome,:email,:empresa,:ramo,:celular,:telefone,:assunto,:mensagem);";
